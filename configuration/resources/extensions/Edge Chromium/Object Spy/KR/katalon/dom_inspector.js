...
function spy_setupEventListeners() {
    ...
    if (window.addEventListener) {
        ...
        window.addEventListener("message", context_receiveMessage, false);
    } else {
        window.attachEvent("onmessage", spy_receiveMessage);
        window.attachEvent("onmessage", context_receiveMessage);
    }
}
...
function spy_disposeEventListeners() {
    ...
    if (window.addEventListener) {
        ...
        window.removeEventListener("message", context_receiveMessage);
    } else {
        window.detachEvent("onmessage", spy_receiveMessage);
        window.detachEvent("message", context_receiveMessage);
    }
}
...
function spy_createInfoDiv() {
    addCustomStyle();
    spy_infoDiv = document.createElement('katalon-div');
...
function spy_createInstructionDiv() {
    spy_instructionDiv = document.createElement('katalon-div');
...
function spy_createXpathDiv() {
    spy_elementInfoDiv = document.createElement('katalon-div');
